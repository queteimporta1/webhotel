...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid mt-4">
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mb-4">Habitaciones Ocupadas</h3>
                    <hr />
                    ...
                    <form method="get" action="ReservaControlador" class="mt-3">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 mt-4">
                                <input type="hidden" name="accion" value="lista_entrada">
                                    ...
                                    <tbody >
                                        <c:forEach items="${reservas}" var="item" >
                                            <tr>
                                                ...
                                                <td>
                                                    <button onclick="fnCargarDetalle(${item.idReserva})" class="btn btn-danger btn-sm">
                                                        <i class="fas fa-hotel"></i> Dar de Alta
                                                    </button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <form action="ReservaControlador" method="post">
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <label>Fecha Hora máxima salida</label>
                                    <input type="text" id="fechaMaxSalida" name="fechaMaxSalida" class="form-control" required disabled="">
                                </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" name="accion" id="accion" value="registrar_salida">
        ...
        function fnCargarDetalle(idReserva) {
            ...
            axios
                    ...
                    .then((response) => {
                        ...
                        document.getElementById("fechaMaxSalida").value = item.fechaMaxSalida;
