...
public class UbicacionControlador extends HttpServlet {
    ...
    protected void ListarSedes(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
    ...
    protected void Inicio(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("pagUbicacion.jsp").forward(request, response);
    }
